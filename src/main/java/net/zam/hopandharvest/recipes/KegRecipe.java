package net.zam.hopandharvest.recipes;
...
public class KegRecipe implements Recipe<SimpleContainer> {
    ...
    @Override
    public ItemStack assemble(SimpleContainer pContainer, RegistryAccess pRegistry) {
    ...
    public static class Serializer implements RecipeSerializer<KegRecipe> {
        ...
        public static final ResourceLocation ID =
                new ResourceLocation(HopsHarvest.MOD_ID, "beer_brewing");
